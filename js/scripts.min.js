...
$( document ).ready(function() {
  ...
  $(window).scroll( function(){
    ...
    if( bottom_of_window > ($aboutTitle.offset().top + $aboutTitle.outerHeight())){
      $('.head_wrap h1').addClass('aboutTitleVisible');
    } 
  /* ##### EXPERIENCE SECTION #### */
...
$(function(){
	...
	$(".my_portfolio li").click(function(){
		$(".my_portfolio li").removeClass("active");
	...
	function heightDetect(){
		$(".header_wrap").css("height", $(window).height());
	}
	heightDetect();
	...
	$(".header_text h1").animated("fadeInDown","fadeOutUp");
	$(".header_text p, .head_wrap h2, .header_text span").animated("fadeInUp","fadeOutDown"); 

	$(".some_info").animated("fadeInLeft","fadeOutLeft");
	$(".personal_info").animated("fadeInRight","fadeOutRight");


	$(".development-wrapper h2").animated("fadeInUp","fadeOutDown");
	$("#form").animated("zoomIn","zoomOut");

	$(".gall_col").each(function(i){
		$(this).find(".loop").attr("href", "#work_" + i);
		$(this).find(".desc_wrap").attr("id", "work_" + i);
	});
